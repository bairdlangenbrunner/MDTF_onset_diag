...
# ======================================================================
# Model name
MODEL=os.environ["model"] # will show up in the MODEL figure
...
FIG_OUTPUT_DIR=BIN_OUTPUT_DIR
# Figure filename for Convective Transition Statistics (CTS)
#  collapsed by shifting CWV by Critical CWV
FIG_FILENAME_CTS=os.environ["CASENAME"]+".convecTransCriticalCollapse_stats"+"_"+TEMP_VAR+".png"
# Figure filename for Critical CWV
FIG_FILENAME_WC=os.environ["CASENAME"]+".convecTransCriticalCollapse_wc"+"_"+TEMP_VAR+".png"

## Binned data filename & figure directory/filename for OBS (default: R2TMIv7) ##
OBS="R2+TMIv7" # will show up in the OBS figure
...
PRECIP_REF_MODEL=1
PRECIP_FIT_MIN_MODEL=3
PRECIP_FIT_MAX_MODEL=5
#
PRECIP_REF_OBS=1
...
### Enter labels as strings; Latex mathtype is allowed within $...$ ##
xlabel['f6']=TEMP_VAR+" "+TEMP_UNITS
ylabel['f6']="$w_c/qsat_{int}$"
...
with open(os.environ["VARCODE"]+"/convecTransCriticalCollapse_parameters.json", "w") as outfile:
