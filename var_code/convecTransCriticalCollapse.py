...
#
#   Version 1 revision 0 05/11/2017 Yi-Hung Kuo (UCLA)
#   Contributors: K. A. Schiro (UCLA), B. Langenbrunner (UCLA), F. Ahmed (UCLA), 
#    C. Martinez (UCLA), C.-C. (Jack) Chen (NCAR)
#   PI: J. David Neelin (UCLA)
#
#   Computes Citical CWV for Convective Transition Statistics following Kuo et al. (201X),
#    similar to Sahany et al. (2012)
#  
#   Generates plots of:
...
os.system("python "+os.environ["VARCODE"]+"/"+"convecTransCriticalCollapse_usp.py")
with open(os.environ["VARCODE"]+"/"+"convecTransCriticalCollapse_parameters.json") as outfile:
...
os.system("echo '<TH ALIGH=LEFT>Collapsed Statistics' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TH ALIGH=CENTER><A HREF=\"casename/"+params_data["FIG_FILENAME_CTS"]+"\">plot</A>' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TH ALIGH=CENTER><A HREF=\"obs/"+params_data["FIG_OBS_FILENAME_CTS"]+"\">plot</A>' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TR>' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TH ALIGH=LEFT>Critical CWV' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TH ALIGH=CENTER><A HREF=\"casename/"+params_data["FIG_FILENAME_WC"]+"\">plot</A>' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TH ALIGH=CENTER><A HREF=\"obs/"+params_data["FIG_OBS_FILENAME_WC"]+"\">plot</A>' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TR>' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
print('...Created!')

print("**************************************************")
print("Convective Transition Thermodynamic Critical Collapse (convecTransCriticalCollapse.py) Excuted!")
print("**************************************************")
