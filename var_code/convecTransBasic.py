...
#    Schiro et al. (2016), Kuo et al. (2017, 201X)
#  
#   Generates plots of:
...
os.system("python "+os.environ["VARCODE"]+"/"+"convecTransBasic_usp_plot.py")
with open(os.environ["VARCODE"]+"/"+"convecTransBasic_plot_parameters.json") as outfile:
...
os.system("echo '<TR>' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
os.system("echo '<TH ALIGH=LEFT>Basic Statistics' >> "+os.environ["WKDIR"]+"/MDTF_"+os.environ["CASENAME"]+"/variab.html")
