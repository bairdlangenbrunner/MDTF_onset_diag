...
#os.environ["DATADIR"] = "/media/kyh/asuka/gfdl/"+os.environ["CASENAME"]
...
#   Depends on the following scripts/files/directories:
#     (1) var_code/convective_transition_diag_v1r0.py
#     (2) var_code/convecTransBasic.py
#     (3) var_code/convecTransBasic_util.py
#     (4) var_code/convecTransBasic_usp_calc.py
#     (5) var_code/convecTransBasic_usp_plot.py
#     (6) var_code/convecTransCriticalCollapse.py
#     (6) var_code/convecTransCriticalCollapse_util.py
#     (8) var_code/convecTransCriticalCollapse_usp.py
#     (9) var_data/convecTransDiag/*
